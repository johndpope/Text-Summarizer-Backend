...
title = unicode('علماء يبتكرون كلمات مرور كيميائية لحماية البيانات ', 'utf-8')
...
titleSimilarity = measureArabicTitleSimilarity(title, sentTokens)

print titleSimilarity
